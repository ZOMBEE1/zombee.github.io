// Datos de ejemplo (camionetas)
    ...
    function mostrarCamionetas() {
      const camionetaSencillaGNList = document.getElementById("camionetaSencillaGNList");
      const camionetaSencillaSPNList = document.getElementById("camionetaSencillaSPNList");
      const camionetaDobleGNList = document.getElementById("camionetaDobleGNList");
      const camionetaDobleSPNList = document.getElementById("camionetaDobleSPNList");
      ...
      camionetasOriginales.forEach((camioneta) => {
        ...
        if (camioneta.empresa === "Grupo Neria" && camioneta.cabina === "Sencilla") {
        ...
        } else if (camioneta.empresa === "Super Pollo " && camioneta.cabina === "Sencilla") {
          countSencillaSPN++;
        ...
        } else if (camioneta.empresa === "Grupo Neria" && camioneta.cabina === "Doble") {
          countDobleGN++;
          const listItemWithNumber = document.createElement("li");
          listItemWithNumber.textContent = `${countDobleGN}. ${listItem.textContent}`;
          camionetaDobleGNList.appendChild(listItemWithNumber);
        } else if (camioneta.empresa === "Super Pollo " && camioneta.cabina === "Doble") {
    ...
    document.getElementById("searchInput").addEventListener("input", filtrarPorNumero);
